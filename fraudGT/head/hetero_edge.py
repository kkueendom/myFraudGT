...
class HeteroGNNEdgeHead(nn.Module):
    ...
    def __init__(self, dim_in, dim_out, dataset):
        ...
        self.use_pair_chain_head = self.edge_decoding in {
            ...
            'pair_chain_contextseqpairseqbridgebankwindowseqselectscalebridge',
        }
        ...
        self.use_sequence_bridge_bank_window_scale_bridge = (
            self.edge_decoding == 'pair_chain_contextseqpairseqbridgebankwindowseqselectscalebridge'
        )
        ...
        if task[0] == task[2]:
            ...
            if self.use_sequence_context_residual and hasattr(batch[task], 'timestamps'):
                ...
                if self.use_sequence_bridge_bank_window:
                    ...
                    pair_src_incoming_sequence_bank = incoming_sequence_bank[pair_src]
                    pair_dst_outgoing_sequence_bank = outgoing_sequence_bank[pair_dst]
                    ...
                    pair_slow_src_incoming_sequence_bank = slow_incoming_sequence_bank[pair_src]
                    pair_slow_dst_outgoing_sequence_bank = slow_outgoing_sequence_bank[pair_dst]
                    if self.use_target_sequence_select:
                        ...
                        pair_src_incoming_sequence_bank = self._filter_sequence_bank(
                            pair_src_incoming_sequence_bank,
                            pair_repr,
                            self.incoming_sequence_select_score,
                        )
                        pair_dst_outgoing_sequence_bank = self._filter_sequence_bank(
                            pair_dst_outgoing_sequence_bank,
                            pair_repr,
                            self.outgoing_sequence_select_score,
                        )
                        ...
                        pair_slow_src_incoming_sequence_bank = self._filter_sequence_bank(
                            pair_slow_src_incoming_sequence_bank,
                            pair_repr,
                            self.incoming_sequence_select_score,
                        )
                        pair_slow_dst_outgoing_sequence_bank = self._filter_sequence_bank(
                            pair_slow_dst_outgoing_sequence_bank,
                            pair_repr,
                            self.outgoing_sequence_select_score,
                        )

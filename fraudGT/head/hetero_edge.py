...
class HeteroGNNEdgeHead(nn.Module):
    ...
    def __init__(self, dim_in, dim_out, dataset):
        ...
        self.use_pair_chain_head = self.edge_decoding in {
            ...
            'pair_chain_contextseqpairseqbridgebankwindowpathsubgraph',
        }
        ...
        self.use_sequence_window_path = (
            self.edge_decoding == 'pair_chain_contextseqpairseqbridgebankwindowpathsubgraph'
        )
    ...
    def _pair_chain_head(self, batch):
        ...
        if self.use_sequence_context_residual:
            ...
            if self.use_sequence_window_path:
                ...
                pred = pred + (
                    torch.sigmoid(self.path_sequence_residual_alpha) * path_sequence_logits
                )
        if self.use_subgraph_context_residual:

...
- Branch: `feature/tmra-dynamic-random`.
- One dynamic-random commit and one hyperparameter set for both datasets.
- Small-LI seed 42 and Large-LI seed 44, 500 epochs each.
- Validation-selected test F1 is the primary endpoint.
- Required Val-selected deltas versus initial A2: at least `+0.005` on both datasets.
- References: Small-LI `0.46247`, Large-LI `0.30108`.
- Raw-best is compared only with A2 Raw-best and remains supplementary.
